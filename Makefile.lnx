...
TARGET25 = test23
TARGET26 = wheat
TARGETS = wheat test23 tables sum10 quad2 quad plusex pay newtab morex gcd fuel f2c exams ex45 ex375 ex37 ex36 ex33 diffsum cycles circle c2f bars avwt arc apples
all: $(TARGETS)
.PHONY: clean
...
$(TARGET23): obj/sum10$(OEXE)
	$(FC) -o sum10 $< $(LDFLAGS)
obj/$(TARGET24)$(OEXE): src/tables.f
	$(FC) -c   $< -o obj/tables$(OEXE) $(FFLAGS)
$(TARGET24): obj/tables$(OEXE)
	$(FC) -o tables $< $(LDFLAGS)
